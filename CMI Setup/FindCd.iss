...
begin
	...
	begin
		...
		begin
			if MsgBox('Please insert Curse Of Monkey Island CD 1 in any drive and press OK.' + Chr(13) + Chr(13) +'Or press cancel to exit setup.', mbConfirmation, MB_OKCANCEL or MB_DEFBUTTON1) = IDOK then
